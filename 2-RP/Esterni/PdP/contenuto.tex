...
Il team ha impiegato un numero di risorse inferiore da quello previsto per il ruolo di Verificatore dovuto al poco tempo rimasto disponibile. Di conseguenza, per questa fase, sono emerse piccole differenze tra il consuntivo e il preventivo per un totale di: -15€.
...
Il team ha impiegato un numero di risorse diverso da quello previsto. Sono emerse alcune differenze con il preventivo: una diminuzione per il ruolo di Amministratore, e una maggiorazione per quelli di Progettista e Responsabile. Di conseguenza, per questa fase, sono emerse differenze tra il consuntivo e il preventivo per un totale di: +58€.
