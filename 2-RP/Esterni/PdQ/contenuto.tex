...
In questo periodo è stata svolta un attività di walkthroughG non avendo gli elementi
...
\hline
\emph{Analisi dei Requisiti vxxx} & € & € \\
\hline
\emph{Norme di Progetto vxxx} & € & € \\
\hline
\emph{Piano di Progetto vxxx} & € & € \\
\hline
\emph{Studio di Fattibilità vxxx} & € & € \\
\hline
\emph{Piano di qualifica vxxx} & € & € \\
\hline
\emph{Glossario vxxx} & € & € \\
\hline
\end{tabular}
...
\begin{center}
  \begin{tabular}{|c|c|c|}
    ...
    \textbf{Documento} & \textbf{Valore indice} & \textbf{Esito} \\
    \hline
    \emph{Analisi dei Requisiti vxxx}  &  & superato \\
    % \hline
    %  \emph{Glossario v1.0.0}  & n & superato \\
    \hline
    \emph{Norme di Progetto vxxx}   &   & superato \\
    \hline
    \emph{Piano di Progetto vxxx}   &  & superato \\
    \hline
    \emph{Piano di Qualifica vxxx}   &  & superato \\
    \hline
    \emph{Studio di Fattibilità vxxx}  &  & superato \\
    \hline
  \end{tabular}
  \captionof{table}{Tabella risultati test Gulpease}
  \end{center}
