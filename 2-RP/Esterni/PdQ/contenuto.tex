...
Vengono qui riportati gli esiti delle verifiche automatizzate per il calcolo dell’indice Gulpease, alle quali sono stati sottoposti tutti i documenti.
...
\textbf{Documento} & \textbf{Valore indice} & \textbf{Esito} \\
\hline
\emph{Analisi dei Requisiti vxxx} & valore & superato \\
\hline
\emph{Norme di Progetto vxxx} & valore & superato \\
\hline
\emph{Piano di Progetto vxxx} & valore & superato \\
\hline
\emph{Studio di Fattibilità vxxx} & valore & superato \\
\hline
\end{tabular}
\captionof{table}{Tabella risultati test Gulpease}
\end{center}
