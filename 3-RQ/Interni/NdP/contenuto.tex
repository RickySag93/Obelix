...
Per verificare ciò vengono utilizzati degli appositi test elencani nel documento "Definizione di Prodotto vXXX" nel capitolo XXXX.
...
Qualsiasi eventuale valore negativo ottenuto dalle  metriche: Schedule Variance o/e Budget Variance dovrà essere  compensato entro la fine dell'attività di progetto modficando e revisionando in modo coerente il Piano di Progetto, in quanto non è possbile eccedere le ore di lavoro finali e il budget finale indicato nella pianificazione.
...
\begin{itemize}
	...
	\item \textbf{Sinon}: libreria per simulare delle risposte di richieste a server remoti
\end{itemize}
