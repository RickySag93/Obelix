...
\begin{enumerate}
	\item Sono stati implementati i Single Component che successivamente verrano integrati nelle bolle che necessitano del loro utilizzo.
	\item Sono stati individuati quattro livelli di testing:
	\begin{itemize}
